...
namespace TOUR.Areas.Admin.Controllers
{
    public class LienHesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "id,tenCty,diaChiCty,sdtCty,emailCty,facebookCty")] LienHe lienHe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,tenCty,diaChiCty,sdtCty,emailCty,facebookCty")] LienHe lienHe)
        {
            if (ModelState.IsValid)
            {
